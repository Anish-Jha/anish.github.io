<template>
    <button class="basic_project_btn_ flex flex-row px-2 items-center justify-center gap-2 text-lg font-bold ">
        <span>
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0,0,256,256"
                style="fill:#ffffff;">
                <g fill="#00ffff" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt"
...
.basic_project_btn_ {
    ...
    box-shadow: 3px 3px 0px 0px hwb(180 8% 40%);
    width: 130px;
}
